...
>
  Ett ramverk som jag ursprungligen planerade skippa till förmån för Angular, men som jag absolut blev kär i när jag faktiskt provade på det. Från att ha börjat bygga individuella komponenter till att bygga hela SPA-lösningar och hybridappar så har React blivit ett av de JavaScript-ramverk jag värderar högst.
</ProjectCard>
<ProjectCard
  title="PHP"
